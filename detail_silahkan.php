        ...
        <div class="container mx-0 mx-sm-5 p-0">
          <div class="collapsible py-4">
            <div class="head px-5">
                <div class="row">
                    <div class="col-auto">
                        <h6 class="text-dark">101</h6>
                    </div>
                    <div class="col-auto">
                        <h6 class="text-dark">Fasha Ar-Rafly</h6>
                    </div>
                </div>
            </div>
            ...
            <div class="row px-5 py-2">
              ...
              <div class="col-lg-6 col-sm-12 px-0 px-lg-5">
                <form action="">
                  ...
                  <input type="text" class="form-control mb-3" placeholder="Contoh: Gojo Satoru" required value="Gojo Satoru">

                  <label class="form-label text-dark">Nim<span class="required">*</span></label>
                  <input type="text" class="form-control mb-3" placeholder="Contoh: 4342411071" required value="4342411071">

                  <label class="form-label text-dark">Tahun Ajaran<span class="required">*</span></label>
                  <input type="text" class="form-control mb-3" placeholder="Contoh: 2024" required value="2024">
              </div>

              <div class="col-lg-6 col-sm-12 px-0 px-lg-5">
                  <label class="form-label text-dark">Jurusan<span class="required">*</span></label>
                  <input type="text" class="form-control mb-3" placeholder="Contoh: Informatika" required value="Informatika">

                  <label class="form-label text-dark">Prodi<span class="required">*</span></label>
                  <input type="text" class="form-control mb-3" placeholder="Contoh: TRPL" required value="TRPL">

                  <label class="form-label text-dark">Alasan Membuat Surat<span class="required">*</span></label>
                  <input type="text" class="form-control mb-3" placeholder="Contoh: Untuk Surat Keterangan Mahasiswa" required value="Untuk Surat Keterangan Mahasiswa">
              </div>
              <div class="col-6 px-0 px-lg-5 mt-2">
                <button class="btn btn-gray">Keluar</button>
              </div>
              <div class="col-6 px-0 px-lg-5 mt-2 d-flex justify-content-end">
                <p class="text-danger mb-0">Silahkan datang 
                <br>ke Pusat Informasi
                </p>
              </div>
            </form>
            </div>
