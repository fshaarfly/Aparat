...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (isset($_POST['remember'])) {
            ...
            setcookie('remember_me', $token, time() + (60 * 60 * 24), "/", "", true, true); // 30 hari
        ...
        if ($data['role'] == 1) {
            header("Location: dosen.php"); // Dosen
        } elseif ($data['role'] == 0) {
            header("Location: dashboard.php"); // Mahasiswa
        }
        exit;
    } else {
        $gagal_script = "
          ...
          <div class="row align-items-center mx-2 mx-sm-5 my-5">
            ...
            <form action="index.php" method="POST">
              ...
              <p class="text-dark text-center" style="font-size: 12px">
                Tidak memiliki akun?
                <a class="daftardisini" href="register.php"
                  >Daftar disini</a
                >
              </p>
            </form>
